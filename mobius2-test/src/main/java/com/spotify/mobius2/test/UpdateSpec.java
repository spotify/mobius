...
public class UpdateSpec<M, E, F> {
  ...
  public interface Then<M, F> {
    ...
    /**
     * Runs the specified test and then invokes the {@link Assert} on the {@link
     * com.spotify.mobius2.test.Result}.
     *
  ...
  public interface Assert<M, F> {
    ...
    void apply(com.spotify.mobius2.test.Result<M, F> result);
  }
