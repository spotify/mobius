...
public class InitSpecTest {
  ...
  private com.spotify.mobius2.test.InitSpec<String, Integer> initSpec;

  @Before
  public void setUp() throws Exception {
    initSpec = new com.spotify.mobius2.test.InitSpec<>(INIT);
  }
  ...
  public void whenAndWhenModelYieldsSameResults() throws Exception {
    com.spotify.mobius2.test.InitSpec.Assert<String, Integer> successAssertion =
        first -> {
          assertThat(first.model(), is("Hello WorldHello World"));
          assertThat(first.effects(), contains(1, 2, 3));
        };
