...
import static com.spotify.mobius2.test.UpdateSpec.assertThatNext;
...
public class UpdateSpecTest {
  ...
  private static final com.spotify.mobius2.test.UpdateSpec<String, String, Integer> CRASH_SPEC =
      new com.spotify.mobius2.test.UpdateSpec<>(
          (model, event) -> {
  ...
  private com.spotify.mobius2.test.UpdateSpec<String, String, Integer> updateSpec;

  @Before
  public void setUp() throws Exception {
    updateSpec = new com.spotify.mobius2.test.UpdateSpec<>(UPDATE);
  }
  ...
  public void whenAndWhenEventYieldSameResult() {
    com.spotify.mobius2.test.UpdateSpec.Assert<String, Integer> assertion =
