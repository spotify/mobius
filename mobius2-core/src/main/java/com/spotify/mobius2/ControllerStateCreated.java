...
class ControllerStateCreated<M, E, F> extends com.spotify.mobius2.ControllerStateBase<M, E> {
  @Nonnull private final com.spotify.mobius2.ControllerActions<M, E> actions;
  @Nonnull private final com.spotify.mobius2.Connection<M> renderer;

  @Nonnull private M nextModelToStartFrom;

  ControllerStateCreated(
      com.spotify.mobius2.ControllerActions<M, E> actions,
      Connection<M> renderer,
      M nextModelToStartFrom) {
