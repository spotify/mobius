...
public interface EventSource<E> {
   ...
   * {@link com.spotify.mobius2.disposables.Disposable} is disposed. Multiple such subscriptions can
   * be in place concurrently for a given event source, without affecting each other.
   *
