...
public class WorkRunners {
  ...
  @Nonnull
  public static com.spotify.mobius2.runners.WorkRunner immediate() {
    return new ImmediateWorkRunner();
  }

  @Nonnull
  public static com.spotify.mobius2.runners.WorkRunner singleThread() {
    return from(Executors.newSingleThreadExecutor());
  }

  @Nonnull
  public static com.spotify.mobius2.runners.WorkRunner fixedThreadPool(int n) {
    return from(Executors.newFixedThreadPool(n));
  }

  @Nonnull
  public static com.spotify.mobius2.runners.WorkRunner cachedThreadPool() {
