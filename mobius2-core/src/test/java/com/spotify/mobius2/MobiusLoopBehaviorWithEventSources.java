...
public class MobiusLoopBehaviorWithEventSources extends MobiusLoopTest {
  ...
  public void invokesEventSourceOnlyOnModelUpdates() {
    ...
    final com.spotify.mobius2.MobiusLoop<String, TestEvent, TestEffect> loop =
  ...
  static class ModelRecordingConnectableEventSource
      implements com.spotify.mobius2.Connectable<String, TestEvent> {
