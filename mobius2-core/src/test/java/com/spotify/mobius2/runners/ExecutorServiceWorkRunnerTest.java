 ...
 * -/-/-
 */
package com.spotify.mobius2.runners;
...
public class ExecutorServiceWorkRunnerTest {
  ...
  private com.spotify.mobius2.runners.ExecutorServiceWorkRunner underTest;
  ...
  public void setUp() throws Exception {
    underTest =
        new com.spotify.mobius2.runners.ExecutorServiceWorkRunner(
  ...
  public void shouldNotReturnFromDisposeUntilFinishedRunning() throws Exception {
    ...
    com.spotify.mobius2.runners.ExecutorServiceWorkRunner backgroundWorkRunner =
        new com.spotify.mobius2.runners.ExecutorServiceWorkRunner(
            Executors.newSingleThreadExecutor());
  ...
  public void disposingShouldStopUnderlyingExecutorService() throws Exception {
    ...
    underTest = new com.spotify.mobius2.runners.ExecutorServiceWorkRunner(service);
    underTest.dispose();
