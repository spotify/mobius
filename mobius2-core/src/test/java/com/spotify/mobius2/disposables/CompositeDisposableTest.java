...
public class CompositeDisposableTest {
  ...
  public void shouldDisposeAllIncludedDisposables() throws Exception {
    ...
    com.spotify.mobius2.disposables.Disposable composite =
        com.spotify.mobius2.disposables.CompositeDisposable.from(one, two, three);
  ...
  public void changingArrayAfterCreatingHasNoEffect() throws Exception {
    ...
    com.spotify.mobius2.disposables.Disposable[] disposables =
        new com.spotify.mobius2.disposables.Disposable[] {one, two, three};

    com.spotify.mobius2.disposables.Disposable composite = CompositeDisposable.from(disposables);
