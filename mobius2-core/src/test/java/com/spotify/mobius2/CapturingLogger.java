...
class CapturingLogger<M, E, F> implements MobiusLoop.Logger<M, E, F> {
  ...
  @Override
  public void afterInit(M model, com.spotify.mobius2.First<M, F> result) {
  ...
  @Override
  public void afterUpdate(M model, E event, com.spotify.mobius2.Next<M, F> result) {
  ...
  abstract static class AfterInitArgs<M, F> {
    ...
    abstract com.spotify.mobius2.First<M, F> first();
  ...
  abstract static class AfterUpdateArgs<M, E, F> {
    ...
    abstract com.spotify.mobius2.Next<M, F> next();
