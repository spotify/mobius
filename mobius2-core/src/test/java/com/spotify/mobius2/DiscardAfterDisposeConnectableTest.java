...
public class DiscardAfterDisposeConnectableTest {
  ...
  private com.spotify.mobius2.Connection<Integer> connection;
  ...
  private com.spotify.mobius2.DiscardAfterDisposeConnectable<Integer, String> underTest;
  ...
  public void setUp() throws Exception {
    ...
    underTest =
        new com.spotify.mobius2.DiscardAfterDisposeConnectable<>(
            new com.spotify.mobius2.Connectable<Integer, String>() {
              @Nonnull
              @Override
              public com.spotify.mobius2.Connection<Integer> connect(Consumer<String> output) {
  ...
  public void nullActualThrowsNPE() throws Exception {
    assertThatThrownBy(
            () -> new com.spotify.mobius2.DiscardAfterDisposeConnectable<Integer, String>(null))
