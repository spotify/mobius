...
public class EventSourceConnectableTest {
  ...
  public void setUp() throws Exception {
    ...
    underTest = com.spotify.mobius2.EventSourceConnectable.create(source);
  ...
  public static class SubscriptionsBehavior extends EventSourceConnectableTest {
    ...
    public void subscribesToEventSourceOnEveryConnect() {
      final com.spotify.mobius2.Connection<Integer> c1 = underTest.connect(events);
      final com.spotify.mobius2.Connection<Integer> c2 = underTest.connect(events);
    ...
    public void disposingUnsubscribesFromEventSource() {
      final com.spotify.mobius2.Connection<Integer> connection = underTest.connect(events);
      connection.dispose();
      assertThat(source.subscriberCount(), is(0));
    }
    ...
    public void disposingThenSubscribingResubscribesToEventSource() {
      com.spotify.mobius2.Connection<Integer> connection = underTest.connect(events);
      assertThat(source.subscriberCount(), is(1));
      connection.dispose();
      assertThat(source.subscriberCount(), is(0));
