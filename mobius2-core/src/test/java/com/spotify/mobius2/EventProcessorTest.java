...
public class EventProcessorTest {
  ...
  private com.spotify.mobius2.EventProcessor<String, Integer, Long> underTest;
  ...
  public void setUp() throws Exception {
    ...
    underTest =
        new com.spotify.mobius2.EventProcessor<>(
            com.spotify.mobius2.MobiusStore.create(createUpdate(), "init!"),
            effectConsumer,
            stateConsumer);
  }
  ...
  private com.spotify.mobius2.Update<String, Integer, Long> createUpdate() {
    return new Update<String, Integer, Long>() {
      @Nonnull
      @Override
      public com.spotify.mobius2.Next<String, Long> update(String model, Integer event) {
        if (event == 0) {
