...
import com.spotify.mobius2.extras.connections.ContramapConnection;
import com.spotify.mobius2.extras.connections.DisconnectOnNullDimapConnection;
import com.spotify.mobius2.extras.connections.MergeConnectablesConnection;
...
public final class Connectables {
   ...
   * {@link MobiusLoop} would be outputting {@code Long} models that you need to convert to Strings
   * before they can be accepted by the UI.
   *
   * <pre>
