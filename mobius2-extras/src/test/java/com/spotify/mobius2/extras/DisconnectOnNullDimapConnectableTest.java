...
import com.spotify.mobius2.extras.domain.A;
import com.spotify.mobius2.extras.domain.B;
import com.spotify.mobius2.extras.domain.C;
import com.spotify.mobius2.extras.domain.D;
...
public class DisconnectOnNullDimapConnectableTest {
  ...
  public void connectsToTargetWhenReceivingNonnullValue() {
    ...
    Assert.assertEquals(TestConnectable.State.CONNECTED, connectable.state);
  }
  ...
  public void disconnectsFromTargetAfterReceivingNullValue() {
    ...
    Assert.assertEquals(TestConnectable.State.CONNECTED, connectable.state);
    connection.accept(A.create(null));
    Assert.assertEquals(TestConnectable.State.DISPOSED, connectable.state);
  }
