...
/**
 * Handle for a connection created by {@link com.spotify.mobius.Connectable}.
 *
...
public interface Connection<I> extends Disposable, Consumer<I> {
  ...
  /**
   * Send a value to this connection. Implementations may receive values from different threads and are
